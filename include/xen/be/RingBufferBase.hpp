...
#ifndef RING_REQUEST_PROD_OVERFLOW
 ...
 * @ingroup backend
 ******************************************************************************/
class XENDLL RingBufferException : public Exception
{
...
class XENDLL RingBufferInBase : public RingBufferBase
{
public:
...
class XENDLL RingBufferOutBase : public RingBufferBase
{
public:
